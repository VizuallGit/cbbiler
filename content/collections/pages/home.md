...
page_sections:
  ...
  -
    ...
    list:
      -
        ...
        text: 'Vi sælger kun håndplukkede luksusbiler i topstand'
        icon:
          name: 'bitcoin-icons:car-outline'
          attributes:
            width: 1em
            height: 1em
            viewBox: '0 0 24 24'
        ...
        local_icon: car
      -
        id: E6XYsKZX7OhBjxgz0iVyU
        text: 'Personlig rådgivning fra start til slut — du handler direkte med ejeren'
        icon:
          name: 'streamline-freehand:business-deal-handshake'
          attributes:
            width: 1em
            height: 1em
            viewBox: '0 0 24 24'
      ...
      -
        ...
        local_icon: kvalitet
      -
        id: PWczSW6vrOfx6tBYtbtFS
        text: 'Skarpe priser og gode finansieringsmuligheder tilpasset dig'
        icon:
          name: 'streamline-freehand:money-bag'
          attributes:
            width: 1em
            height: 1em
            viewBox: '0 0 24 24'
  ...
  -
    ...
    enabled: true
  -
    id: uPDLRQ3l1_x3dlwE3yMQm
    title: 'List med biler til salg'
    list:
